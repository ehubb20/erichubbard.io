...
| Reader | BI/analytics **leadership hiring managers** one step up — not recruiters (the résumé handles them), not AI/ML managers. |
...
- Third-party tool names (Linear, Asana, Zendesk, Amazon, eBay) are fine and used
  consistently; they are public products, not client information.
